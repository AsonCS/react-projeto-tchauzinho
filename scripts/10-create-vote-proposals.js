...
const vote = sdk.getVote(process.env.NEXT_PUBLIC_VOTE_CONTRACT_ADDRESS)
...
const run = async () => {
	...
	try {
		...
		const description = `A DAO deveria transferir ${amount} tokens do tesouro para ${process.env.WALLET_ADDRESS} por ser uma pessoa incrível?`
